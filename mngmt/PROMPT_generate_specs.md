...
1. Study existing specs/ and identify code without specs
3. Use an Opus subagent to analyze findings and create/update spec using format from `specs/02-code-to-spec.md` Ultrathink.
...
2. Pick highest-priority unspecified component
3. Generate spec using format from `02-code-to-spec.md`
